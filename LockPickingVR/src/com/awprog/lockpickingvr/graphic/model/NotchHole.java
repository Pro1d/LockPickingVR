 ...
 */
public class NotchHole extends Object {
    ...
    static protected final float dist[] = {0.26f, 0.50f, 0.85f};
    private final float thickness;

    static final float color[] = { 0.8f, 0.5f, 0.2f, 1.0f };

    /**
     * Sets up the drawing object data for use in an OpenGL ES context.
     */
    public NotchHole(float thickness, float tz) {
    ...
    public void update(FilledPolarPlan plan, float tz) {
    	// Internal cylinder
